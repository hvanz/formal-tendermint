...
(* honest-scoped Agreement / Validity already established for              *)
...
(*   TendermintByzantine does not mention them, so they are projected      *)
(*   away.                                                                 *)
(*                                                                         *)
...
(*   TendermintPartialSync (the pigeonhole facts; TLC-checked at f=1),     *)
(*   cited by name.                                                        *)
(* - ValidatorsNonEmpty (Validators # {}) and HonestNonEmpty (Honest # {}) *)
(*   : the cardinality assumptions of TendermintPartialSync (|Validators|  *)
(*   = 3f+1, |Faulty| <= f, both finite) yield these via FiniteSetTheorems *)
(*   -- proved here (ValidatorsNonEmptyL / HonestNonEmptyL).               *)
(*                                                                         *)
(* MAIN RESULTS                                                            *)
...
(* Validity theorems are in scope for the safety transfer                  *)
(* below.                                                                  *)
(***************************************************************************)
...
(* Agreement / Validity (already proved in                                 *)
