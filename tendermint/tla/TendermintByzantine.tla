...
(*                                                                         *)
(* SCOPE                                                                   *)
(*   Single height. Up to f Byzantine validators. Rounds unbounded         *)
(*   (Nat). Asynchronous, safety only: Spec == Init /\ [][Next]_vars,      *)
(*   no fairness, no liveness. The safety properties (Agreement,           *)
(*   Validity, Integrity) are re-scoped to the HONEST validators, the      *)
(*   only ones whose decision is meaningful. Honest-scoped safety is       *)
(*   proved by refinement onto the operational spec                        *)
(*   (TendermintByzantineRefinement); liveness under Byzantine leaders     *)
(*   is addressed later at TendermintPartialSync.                          *)
(***************************************************************************)
